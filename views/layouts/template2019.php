...
<!--            </form>-->
           ...
           <? } ?>
            ...
            $category = \app\models\category::find()->all();
              ...
              <li class="treeview">
              <a href="<?//=$menu['url'] ?>" onclick='<?php if($menu['id_category']=='#') 
              echo '$.get("index.php?r=kassa/default/category&id_category='.$menu['id_category'].'", function(data){
            $("#content").html(data);})'; ?>'>
